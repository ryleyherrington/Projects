...
@interface GrammaticsObject : KrollCoverageObject {
#else
@interface GrammaticsObject : KrollObject {
#endif
@private
...
extern NSString * Grammatics$ModuleRequireFormat;
