...
// in simulator we redefine to format for Grammatics Developer console
...
{\
	NSString * exceptionName = [@"org.grammatics." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.grammatics";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGrammaticsNativeItemNone = -1, 
	UIGrammaticsNativeItemSpinner = -2,
	UIGrammaticsNativeItemProgressBar = -3,
	
	UIGrammaticsNativeItemSlider = -4,
	UIGrammaticsNativeItemSwitch = -5,
	UIGrammaticsNativeItemMultiButton = -6,
	UIGrammaticsNativeItemSegmented = -7,
	
	UIGrammaticsNativeItemTextView = -8,
	UIGrammaticsNativeItemTextField = -9,
	UIGrammaticsNativeItemSearchBar = -10,
	
	UIGrammaticsNativeItemPicker = -11,
	UIGrammaticsNativeItemDatePicker = -12,
	
	UIGrammaticsNativeItemInfoLight = -13,
	UIGrammaticsNativeItemInfoDark = -14,
	
	UIGrammaticsNativeItemDisclosure = -15,
	
	UIGrammaticsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Grammatics instances of
