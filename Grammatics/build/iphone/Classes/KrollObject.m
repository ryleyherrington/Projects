...
//@interface GrammaticsObject : NSObject
//@end

@interface GrammaticsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GrammaticsObject class]])
		{
			for (NSString *key in [[(GrammaticsObject*)o modules] allKeys])
			{
