...
/**
 The base class for all Grammatics modules
 */
...
/**
 Grammatics Platform calls this method on startup.
 */
-(void)startup;

/**
 Grammatics Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Grammatics Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Grammatics Platform calls this method on resume.
 @param sender The sender of the event.
 */
